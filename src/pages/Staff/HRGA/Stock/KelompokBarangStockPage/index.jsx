...
import { getKelompokBarangStock, addKelompokBarangKategoriStock } from "@/features/hr/stockApiService";
import {
...
const KelompokBarangPageStock = () => {
    ...
    const { data: kelompokData = [], isLoading, isError } = useQuery({
        queryKey: ["kelompokBarangStock"],
        queryFn: getKelompokBarangStock,
        staleTime: 5 * 60 * 1000,
        refetchOnWindowFocus: false,
    });

    const addMutation = useMutation({
        mutationFn: addKelompokBarangKategoriStock,
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["kelompokBarangStock"] });
...
export default KelompokBarangPageStock;