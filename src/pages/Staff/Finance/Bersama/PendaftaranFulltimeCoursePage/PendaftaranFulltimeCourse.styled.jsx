...
export const PendaftaranFulltimeCourseStyled = styled.div`
  padding: 24px;
  min-height: 100vh;
  ...
  /* Stats Grid */
  .stats-grid-pendaftaranFulltime {
    display: grid;
  ...
  .table-wrapper {
    ...
    table {
      width: 100%;
      min-width: 1900px; /* Wide table for 14 columns + action */
      ...
      tbody {
        tr {
          ...
          /* Ensure hover covers sticky column */
