...
import { getReviewKaryawanFinance, submitReviewKaryawanFinance } from "@/features/finance/financeApiService";
import { StyledReviewKaryawanFin } from "./ReviewKaryawanFin.styled";
...
function ReviewKaryawanPageFin() {
    ...
    const { data: reviewHistory, isLoading: loadingHistory } = useQuery({
        ...
        queryFn: () => getReviewKaryawanFinance(selectedKaryawan),
    ...
    const submitMutation = useMutation({
        mutationFn: submitReviewKaryawanFinance,
        onSuccess: () => {
            toast({
                title: "Berhasil",
    ...
    const handleSubmit = () => {
        ...
        submitMutation.mutate({
            reviewer: currentUser?.nama || 'Unknown',
    ...
    const historyTableData = useMemo(() => {
        ...
        const currentUserReviews = reviewHistory.result.filter(
            item => item.reviewer === currentUser?.nama
        );
    ...
    return (
        <StyledReviewKaryawanFin data-theme={colorMode}>
            <ContainerCarrot>
        ...
        </StyledReviewKaryawanFin>
    );
}

export default ReviewKaryawanPageFin;